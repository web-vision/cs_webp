...
This product ("web-vision/cs_webp") is developed and maintained by web-vision GmbH.
...
Planned end of support for this product: **30 November 2018 (end of regular TYPO3 7 LTS support)**.
...
channels of "web-vision/cs_webp" (e.g. TER / Packagist).
